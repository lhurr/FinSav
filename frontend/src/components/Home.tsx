    ...
    <div className="pt-20 bg-gray-50 w-full text-center text-xl">
      ...
      <div className="mt-10 ml-40 mr-40 mb-10 mx-5 p-5 bg-white shadow-md rounded-lg">
        ...
        <p className="text-lg mb-5">
          FinSav is a cutting-edge <i>real-time</i> smart finance tool powered by advanced language models designed to provide insights to all your finance-related questions. Whether you're looking for up-to-date market trends, investment advice, or financial planning tips, FinSav is here to help.
        </p>
      </div>
      <Link to="chat">
